const meta = {
  '/': {
    ...
    description: `XELIS is the world's first BlockDAG with Privacy, Speed, Scalability and Smart Contracts.`,
    keywords: `BlockDAG, Homomorphic Encryption, Privacy, Confidentiality, Smart Contracts, Rust, Decentralized, Cryptocurrency, Blockchain, XELIS, XEL, Bitcoin, BTC, ETH, Ethereum, Monero, XMR`
  },
  '/resources': {
