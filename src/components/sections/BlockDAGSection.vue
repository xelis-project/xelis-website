    ...
    <section id="blockdag">
      ...
      <ul class="content">
        ...
        >
          ...
          <div class="text">
            Reduce rate of orphan's blocks when miners find a block at the same time.
          </div>
        </li>
        <li
          :class="{'fade': !preRendered,}"
        ...
        >
          ...
          <div class="text">
            ...
            <ul class="list">
              ...
              <li>
                Orphaned: This block was not ordered in the DAG and has no topographical height (its transactions are not executed).
              </li>
            </ul>
          </div>
        </li>
